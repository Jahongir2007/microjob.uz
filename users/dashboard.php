...
if(isset($_SESSION['user_role'])){
    if($_SESSION['user_role'] !== 'student' && $_SESSION['user_role'] === 'employer'){ // only allow students
        // redirect employers/universities to their dashboard
        header("Location: employer_dashboard.php");
        exit();
    }else if($_SESSION['user_role'] !== 'student' && $_SESSION['user_role'] === 'university'){
...
<nav class="hidden md:flex justify-between items-center bg-white shadow p-4 px-8 sticky top-0 z-10">
    ...
    <div class="space-x-6">
        ...
        <a href="logout.php" class="text-gray-600 hover:text-blue-600">🚪 Akkauntdan chiqish</a>
    </div>
</nav>
...
$(document).ready(function(){
    ...
    $.getJSON("get_jobs.php", function(data){
        jobsData = data;
        renderJobs(jobsData);
    });
